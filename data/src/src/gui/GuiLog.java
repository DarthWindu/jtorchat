...
public class GuiLog extends JFrame {
  ...
  private void initDocument() {
    DefaultStyledDocument defaultStyledDocument = (DefaultStyledDocument) textPane1.getDocument();
  ...
  static {
    Gui.setLAF("Nimbus");
    //FIXME determine if this is a bug. I think it is. --> instance = new GuiLog();
